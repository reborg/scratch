...
public class ExprParser extends Parser {
    ...
    // $ANTLR start "expr"
    // test/sqlparser/test/Expr.g:18:1: expr : term ( ( PLUS | MINUS ) term )* ;
    public final ExprParser.expr_return expr() throws RecognitionException {
        ...
        try {
            // test/sqlparser/test/Expr.g:18:5: ( term ( ( PLUS | MINUS ) term )* )
            // test/sqlparser/test/Expr.g:18:7: term ( ( PLUS | MINUS ) term )*
            {
            ...
            // test/sqlparser/test/Expr.g:18:12: ( ( PLUS | MINUS ) term )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // test/sqlparser/test/Expr.g:18:13: ( PLUS | MINUS ) term
            	    {
    ...
    // $ANTLR start "term"
    // test/sqlparser/test/Expr.g:19:1: term : factor ( ( MULT | DIV ) factor )* ;
    public final ExprParser.term_return term() throws RecognitionException {
        ...
        try {
            // test/sqlparser/test/Expr.g:19:5: ( factor ( ( MULT | DIV ) factor )* )
            // test/sqlparser/test/Expr.g:19:7: factor ( ( MULT | DIV ) factor )*
            {
            root_0 = (CommonTree)adaptor.nil();
            ...
            // test/sqlparser/test/Expr.g:19:14: ( ( MULT | DIV ) factor )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // test/sqlparser/test/Expr.g:19:15: ( MULT | DIV ) factor
            	    {
    ...
    // $ANTLR start "factor"
    // test/sqlparser/test/Expr.g:20:1: factor : INT ;
    public final ExprParser.factor_return factor() throws RecognitionException {
        ...
        try {
            // test/sqlparser/test/Expr.g:20:7: ( INT )
            // test/sqlparser/test/Expr.g:20:9: INT
            {
            root_0 = (CommonTree)adaptor.nil();
